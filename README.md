...
### [View user-auth-register-domain-events-RabbitMQ.plantuml](./uml/10-user-auth-register-domain-events-RabbitMQ.plantuml)

<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-g.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
<br>
<br>

<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-01.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-02.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-03.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-04.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-05.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-06.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-08.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
<img src="./diagrams/10-feat-user-auth-register-domain-events-RabbitMQ-09.png" alt="Architecture Diagram" style="max-width: 800px; max-height: 500px; width: 100%; height: auto;">
</div>

<div align="left">
⚡️Add createdByAdminId and address fields to the athj_user_register endpoint request payload.<br>
⚡️Adapt auth-service-java to handle domain events.<br>
⚡️Integrate RabbitMQ into the docker-compose configuration.<br>
⚡️Create the domain events AdministratorRegisteredEvent (naming convention: amr.shop.event.v1.auth.administrator.registered) and CustomerRegisteredEvent (naming convention: amr.shop.event.v1.auth.customer.registered).<br>
⚡️Implement functionality in AggregateRoot to persist domain events.<br>
⚡️Enable event communication between auth-service-java and user-context services.<br>
⚡️Add an event dispatcher within auth-service-java and an external integration with RabbitMQ.<br>
⚡️Fix service dependencies and environment variables for running user-context, auth-service-java, and api-gateway containers.<br>
⚡️Update the port number of shopdb service to 3307.<br>
⚡️Add the customer role.<br>
⚡️Adapt user-context to process incoming domain events.<br>
⚡️Update the UserAuthModel aggregate to support domain-driven changes.<br>
⚡️Modify the UserAuthRegister command to emit domain events generated by UserAuthModel.<br>
</div>
