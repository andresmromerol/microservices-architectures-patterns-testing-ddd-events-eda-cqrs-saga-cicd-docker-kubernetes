...
public class AuthExceptionHdr {
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    public ExceptionDTO handlerUserAuthUserNotFoundException(UserAuthUserNotFoundException exception) {
    ...
    public ExceptionDTO handlerTokenSaveFailed(TokenSaveFailedException exception) {
        ...
        return buildExceptionDTO(HttpStatus.INTERNAL_SERVER_ERROR, AUTH_TOKEN_SAVE_FAILED, exception.getMessage());
    }
