...
class UserViewPersistenceAdapterTest {
  ...
  @Mock private UserViewJpaRepository userViewJpaRepository;

  @Mock private UserViewPersistenceMapper userViewPersistenceMapper;
  ...
  void setUp() {
    ...
    userViewPersistenceAdapter =
        new UserViewPersistenceAdapter(userViewJpaRepository, userViewPersistenceMapper);
  }
