...
class TokenAdapterTest {
  ...
  private static final String TEST_SECRET_KEY =
      "6F7564526E4A586C6F336437754C35766B594E5138394650425378586C414F62";
  ...
  void shouldGenerateTokenWithValidClaims() {
    ...
    BuildTokenDto tokenDto =
        new BuildTokenDto(USER_ID, USER_NAME, USER_EMAIL, roles, TOKEN_EXPIRATION);
  ...
  void shouldThrowExceptionWhenTokenExpired() {
    BuildTokenDto tokenDto =
        new BuildTokenDto(
            USER_ID, USER_NAME, USER_EMAIL, Collections.singleton(RoleEnum.USER), -3600000L);
    String token = tokenAdapter.generateToken(tokenDto, secretKey);
