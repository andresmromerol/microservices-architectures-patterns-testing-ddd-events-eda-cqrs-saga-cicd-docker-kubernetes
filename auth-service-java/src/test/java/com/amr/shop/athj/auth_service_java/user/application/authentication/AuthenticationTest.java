...
class AuthenticationTest {
  ...
  void shouldAuthenticateUserSuccessfully() {
    ...
    when(queryBus.ask(argThat(arg -> arg instanceof TokenGenerateQry)))
        .thenReturn(tokenGenerateRes);
  ...
  void shouldThrowExceptionWhenUserNotFound() {
    UserSearchByEmailRes emptyRes = UserSearchByEmailRes.builder().isEmpty(true).build();
